...
public class Lua_UITweenPosition : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int Play(IntPtr l) {
		try {
			UITweenPosition self=(UITweenPosition)checkSelf(l);
			self.Play();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UITweenPosition");
		addMember(l,Play);
		addMember(l,"from_",get_from_,set_from_,true);
		addMember(l,"to_",get_to_,set_to_,true);
		createTypeMetatable(l,null, typeof(UITweenPosition),typeof(UITweenBase));
	}
}
