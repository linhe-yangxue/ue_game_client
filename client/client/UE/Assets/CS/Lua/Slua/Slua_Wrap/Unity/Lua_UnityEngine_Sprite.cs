...
public class Lua_UnityEngine_Sprite : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ToRegionAttachment(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(Spine.AtlasPage),typeof(float))){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
				Spine.AtlasPage a2;
				checkType(l,2,out a2);
				System.Single a3;
				checkType(l,3,out a3);
				var ret=self.ToRegionAttachment(a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(UnityEngine.Material),typeof(float))){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ToRegionAttachmentPMAClone(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(argc==5){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
				...
				var ret=self.ToRegionAttachmentPMAClone(a2,a3,a4,a5);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				System.Boolean a4;
				checkType(l,4,out a4);
				UnityEngine.Material a5;
				checkType(l,5,out a5);
				System.Single a6;
				checkType(l,6,out a6);
				var ret=self.ToRegionAttachmentPMAClone(a2,a3,a4,a5,a6);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ToAtlasRegion(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(UnityEngine.Material))){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
				UnityEngine.Material a2;
				checkType(l,2,out a2);
				var ret=self.ToAtlasRegion(a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(Spine.AtlasPage))){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
				Spine.AtlasPage a2;
				checkType(l,2,out a2);
				var ret=self.ToAtlasRegion(a2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ToAtlasRegionPMAClone(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(argc==4){
				UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
				...
				System.Boolean a4;
				checkType(l,4,out a4);
				var ret=self.ToAtlasRegionPMAClone(a2,a3,a4);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				UnityEngine.Material a5;
				checkType(l,5,out a5);
				var ret=self.ToAtlasRegionPMAClone(a2,a3,a4,a5);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ToRegionAttachment);
		addMember(l,ToRegionAttachmentPMAClone);
		addMember(l,ToAtlasRegion);
		addMember(l,ToAtlasRegionPMAClone);
