...
public class Lua_UnityEngine_Transform : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int WorldFromMatrix4x4(IntPtr l) {
		try {
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			UnityEngine.Matrix4x4 a2;
			checkValueType(l,2,out a2);
			self.WorldFromMatrix4x4(a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int LocalFromMatrix4x4(IntPtr l) {
		try {
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			UnityEngine.Matrix4x4 a2;
			checkValueType(l,2,out a2);
			self.LocalFromMatrix4x4(a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int DOScale(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(float),typeof(float))){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
				System.Single a2;
				checkType(l,2,out a2);
				System.Single a3;
				checkType(l,3,out a3);
				var ret=self.DOScale(a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,WorldFromMatrix4x4);
		addMember(l,LocalFromMatrix4x4);
		addMember(l,DOMove);
		addMember(l,DOMoveX);
		addMember(l,DOMoveY);
		addMember(l,DOMoveZ);
