...
#pragma warning restore 414
    ...
    public class LuaDLL
    {
        ...
        {
            return LuaDLL.luaL_loadbufferx(luaState, buff, size, name, IntPtr.Zero);
        }
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaS_checkBounds(IntPtr l, int p, out float cx, out float cy, out float cz, out float ex, out float ey, out float ez);
        ...
        // custom
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaS_SetBreakSig(IntPtr l);
    }
}
