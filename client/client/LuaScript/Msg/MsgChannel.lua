...
function MsgChannel:SendLoverPurchase(data, cb)
    self:_SendMsgByProto("c_lover_recharge", data, cb)
end
...
function MsgChannel:SendHeroPurchase(data, cb)
    self:_SendMsgByProto("c_hero_recharge", data, cb)
end
