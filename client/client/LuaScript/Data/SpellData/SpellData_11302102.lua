return {
	...
	['groups'] = {
		...
		[5] = {
			...
			['target_type'] = {['target_type'] = 6, ['segment'] = 1, ['ghost_id'] = 0},
			['layer'] = -1,
			['spell_action_type'] = 'SetUnitLayer',
			['happen_frame'] = 13
		},
		[6] = {
			['target_type'] = {['target_type'] = 2, ['segment'] = 1, ['ghost_id'] = 0},
		...
		[9] = {
			...
			['replace_action'] = false,
			['target_type'] = {['target_type'] = 2, ['segment'] = 1, ['ghost_id'] = 0},
			['pos_data'] = {['condition'] = 2, ['pos'] = {['pos_type'] = 9, ['ghost_id'] = 0, ['unit_body_type_first'] = 6, ['unit_body_type_second'] = 1, ['offset_coefficient_first'] = 2.5, ['offset_coefficient_second'] = 0, ['fix_pos'] = {8.60, 0.30, 0.00}, ['enemy_fix_pos'] = {-6.65, -23.40, 0.00}}, ['second_pos'] = {['pos_type'] = 9, ['ghost_id'] = 0, ['unit_body_type_first'] = 6, ['unit_body_type_second'] = 1, ['offset_coefficient_first'] = 2.5, ['offset_coefficient_second'] = 0, ['fix_pos'] = {13.49, 8.54, 0.00}, ['enemy_fix_pos'] = {-11.60, -30.60, 0.00}}, ['third_pos'] = {['pos_type'] = 1, ['ghost_id'] = 0, ['unit_body_type_first'] = 1, ['unit_body_type_second'] = 1, ['offset_coefficient_first'] = 0, ['offset_coefficient_second'] = 0}},
			['change_time'] = 15,
			['move_speed'] = 0,
			['relative_dis'] = 0,
			['move_curve'] = {
		...
		[14] = {
			...
			['effect_id'] = '1113021014',
			['is_attach_target'] = true,
			['level_type'] = 'MaxLevel',
			['level_offset'] = 0,
			['pos_data'] = {['condition'] = 1, ['pos'] = {['pos_type'] = 11, ['ghost_id'] = 0, ['unit_body_type_first'] = 6, ['unit_body_type_second'] = 7, ['offset_coefficient_first'] = 0, ['offset_coefficient_second'] = 1.79999995231628}, ['second_pos'] = {['pos_type'] = 1, ['ghost_id'] = 0, ['unit_body_type_first'] = 1, ['unit_body_type_second'] = 1, ['offset_coefficient_first'] = 0, ['offset_coefficient_second'] = 0}, ['third_pos'] = {['pos_type'] = 1, ['ghost_id'] = 0, ['unit_body_type_first'] = 1, ['unit_body_type_second'] = 1, ['offset_coefficient_first'] = 0, ['offset_coefficient_second'] = 0}},
			['life_time'] = 0,
			['effect_scale'] = 1,
			['vector_scale'] = {1.00, 1.00, 1.00},
			['enemy_vector_scale'] = {1.00, 1.00, 1.00},
		...
		[15] = {
			...
			['speed_curve'] = {
				...
				['postWrapMode'] = 8,
				['keys'] = {
					[1] = {['time'] = 0, ['value'] = 0, ['inTangent'] = 3.0873601436615, ['outTangent'] = 3.0873601436615, ['tangentMode'] = 0},
					[2] = {['time'] = 1, ['value'] = 1, ['inTangent'] = 0.0272538606077433, ['outTangent'] = 0.0272538606077433, ['tangentMode'] = 0}
				}
			},
			['shadow_fllow_type'] = 'NormalFollow',
			['is_limit_edge'] = false,
		...
		[19] = {
			...
			['replace_action'] = false,
			['target_type'] = {['target_type'] = 3, ['segment'] = 1, ['use_delay'] = true, ['delay_list'] = {[1] = 0.100000001490116, [2] = 0.0500000007450581, [3] = 0, [4] = 0.100000001490116, [5] = 0.0500000007450581, [6] = 0}, ['use_opposite'] = true, ['enemy_delay_list'] = {[1] = 0, [4] = 0, [2] = 0.0500000007450581, [5] = 0.0500000007450581, [3] = 0.100000001490116, [6] = 0.100000001490116}, ['ghost_id'] = 0},
			['end_color'] = {0.9150943,0.9150943,0.9150943,1},
			['is_change_hud'] = false,
			['change_curve'] = {
				['preWrapMode'] = 8,
				['postWrapMode'] = 8,
		...
		[20] = {
			['hit_segment'] = 1,
			['delay1'] = 0.100000001490116,
			['delay2'] = 0.0500000007450581,
			['delay3'] = 0,
			['delay4'] = 0.100000001490116,
