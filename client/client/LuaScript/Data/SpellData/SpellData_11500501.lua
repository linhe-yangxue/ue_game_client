return {
	...
	['groups'] = {
		...
		[6] = {
			...
			['replace_action'] = false,
			['rotate_model'] = false,
			['end_euler'] = {0.00, 0.00, -18.00},
			['enemy_end_euler'] = {0.00, 0.00, 18.00},
			['target_type'] = {['target_type'] = 2, ['segment'] = 1, ['ghost_id'] = 0},
			['change_time'] = 4,
			['change_curve'] = {
				['preWrapMode'] = 8,
