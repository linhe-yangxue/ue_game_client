...
Vector4 = 
{
	...
	z = 0,
	w = 0,
	__typename = "Vector4",  -- 注意__typename是C#中识别类型的凭证
}
...
function Vector4.NewByTable(t)
	return Vector4.New(t[1] or 0, t[2] or 0, t[3] or 0, t[4] or 0)
end

function Vector4.NewByVector4(v4)
    return Vector4.New(v4.x, v4.y, v4.z, v4.w)
end
