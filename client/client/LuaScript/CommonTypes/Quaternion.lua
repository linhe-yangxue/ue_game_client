...
Quaternion = 
{
	__typename = "Quaternion",  -- 注意__typename是C#中识别类型的凭证
}
...
function Quaternion.NewByQuat(t)
	return Quaternion.New(t.x, t.y, t.z, t.w)
end

function Quaternion.NewByTable(t)
	return Quaternion.New(t[1] or 0, t[2] or 0, t[3] or 0, t[4] or 0)
end
...
function Quaternion.Rot2Dir(rot)
	rot = rot * math.deg2Rad
	return Vector3.New(sin(rot), 0, cos(rot))
end
